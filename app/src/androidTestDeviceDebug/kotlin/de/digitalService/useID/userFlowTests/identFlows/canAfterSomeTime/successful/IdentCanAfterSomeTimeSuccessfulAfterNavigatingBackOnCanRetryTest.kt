...
//@HiltAndroidTest
//class IdentCanAfterSomeTimeSuccessfulAfterNavigatingBackOnCanRetryTest {
//
//    @get:Rule(order = 0)
...
//    @Test
//    fun testIdentCanAfterSomeTimeSuccessfulAfterNavigatingBackOnCanRetry() = runTest {
...
//
//        // TODO: Going further back should not be possible here! Ticket: https://digitalservicebund.atlassian.net/browse/USEID-907
//        identificationCanIntro.setBackAllowed(false).setIdentPending(true).assertIsDisplayed()
//        identificationCanIntro.enterCanNowBtn.click()
//
//        // ENTER CORRECT CAN
//        identificationCanInput.setRetry(false).assertIsDisplayed()
//        identificationCanInput.canEntryField.assertLength(0)
