...
@HiltAndroidTest
class SetupAndIdentSuccessfulAfterPersonalPinWrongOnceInIdentTest {
    ...
    @Test
    fun testSetupAndIdentSuccessfulAfterPersonalPinWrongOnceInIdent() = runTest {
        ...
        identificationScan.setProgress(false).assertIsDisplayed() // TODO progress indicator should not be shown yet
