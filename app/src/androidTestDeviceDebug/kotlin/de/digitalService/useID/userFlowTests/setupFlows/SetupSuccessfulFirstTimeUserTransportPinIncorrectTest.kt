...
class SetupSuccessfulFirstTimeUserTransportPinIncorrectTest {
    ...
    fun setupSuccessfulFirstTimeUserTransportPinIncorrect() = runTest {
        ...
        setupScan.backAllowed(false).progress(false).assertIsDisplayed() // TODO: Should back be allowed here?

        eidFlow.value = EidInteractionEvent.CardRecognized
        advanceUntilIdle()

        setupScan.backAllowed(false).progress(true).assertIsDisplayed() // TODO: Should back be allowed here?
