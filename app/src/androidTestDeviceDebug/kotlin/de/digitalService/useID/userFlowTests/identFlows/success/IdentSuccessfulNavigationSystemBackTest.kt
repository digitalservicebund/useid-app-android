...
//@HiltAndroidTest
//class IdentSuccessfulNavigationSystemBackTest {
//
//    @get:Rule(order = 0)
...
//    @Test
//    fun testIdentSuccessfulNavigationSystemBack() = runTest {
...
//        composeTestRule.performPinInput(personalPin)
//        identificationPersonalPin.personalPinField.assertLength(personalPin.length)
//        Espresso.pressBack() // TODO: Going back should work and show the identificationAttributeConsent screen. Ticket: https://digitalservicebund.atlassian.net/browse/USEID-907
//
//        identificationAttributeConsent.assertIsDisplayed()
//        identificationAttributeConsent.continueBtn.click()
//
