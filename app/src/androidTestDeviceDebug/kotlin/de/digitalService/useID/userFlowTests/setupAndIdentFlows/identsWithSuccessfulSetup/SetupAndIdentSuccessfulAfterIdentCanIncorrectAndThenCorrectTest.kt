package de.digitalService.useID.userFlowTests.setupAndIdentFlows.identsWithSuccessfulSetup
...
import de.digitalService.useID.userFlowTests.utils.flowFragments.runSuccessfulSetup
...
@HiltAndroidTest
class SetupAndIdentSuccessfulAfterIdentCanIncorrectAndThenCorrectTest {
    ...
    @Test
    fun testSetupAndIdentSuccessfulAfterIdentCanIncorrectAndThenCorrect() = runTest {
        ...
        // ENTER WRONG PERSONAL PIN 1ST TIME
        ...
        // ENTER WRONG PERSONAL PIN 2ND TIme
        ...
        identificationScan.setProgress(false).assertIsDisplayed() // TODO the progress indicator should not be shwon yet
        ...
        identificationScan
            ...
            .setProgress(false) // TODO the progress indicator should not be shown yet
            .assertIsDisplayed()
        ...
        identificationScan
            .setIdentPending(true)
            .setBackAllowed(false)
            .setProgress(false) // TODO progress indicator should not be shwon yet
            .assertIsDisplayed()
