...
import de.digitalService.useID.userFlowTests.utils.flowFragments.runSetupCanSuccessful
...
@HiltAndroidTest
class SetupAndIdentSuccessfulAfterCanCorrectInSetupTest {
    ...
    @Test
    fun testSetupAndIdentSuccessfulAfterCanCorrectInSetup() = runTest {
