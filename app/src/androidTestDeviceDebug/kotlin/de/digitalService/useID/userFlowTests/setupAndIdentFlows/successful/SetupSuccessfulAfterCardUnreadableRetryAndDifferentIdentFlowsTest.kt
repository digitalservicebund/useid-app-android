...
//import de.digitalService.useID.userFlowTests.utils.flowParts.setup.runSetupSuccessfulAfterCardUnreadableWithSuccessfulRetry
...
//@HiltAndroidTest
//class SetupSuccessfulAfterCardUnreadableRetryAndDifferentIdentFlowsTest {
//
//    @get:Rule(order = 0)
...
//        advanceUntilIdle()
//
//        runSetupSuccessfulAfterCardUnreadableWithSuccessfulRetry(
...
//    @OptIn(ExperimentalCoroutinesApi::class)
//    @Test
//    fun testSuccessfulSetupAfteCardUnreadableRetryFollowedSuccessfulIdentAfterPersonalPinIncorrectTwiceAndThenCorrect() = runTest {
//        every { mockCoroutineContextProvider.IO } returns StandardTestDispatcher(testScheduler)
//        every { mockCoroutineContextProvider.Default } returns StandardTestDispatcher(testScheduler)
//
//        val eidFlow = MutableStateFlow<EidInteractionEvent>(EidInteractionEvent.Idle)
