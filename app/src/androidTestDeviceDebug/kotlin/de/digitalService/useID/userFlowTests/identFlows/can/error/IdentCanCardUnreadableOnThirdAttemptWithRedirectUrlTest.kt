package de.digitalService.useID.userFlowTests.identFlows.can.error
...
@HiltAndroidTest
class IdentCanCardUnreadableOnThirdAttemptWithRedirectUrlTest {
    ...
    @Test
    fun testIdentCanCardUnreadableOnThirdAttempt() = runTest {
