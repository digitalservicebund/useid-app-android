...
@HiltAndroidTest
class SetupAndIdentSuccessfulAfterIdentCanCorrectTest {
    ...
    @Test
    fun testSetupAndIdentSuccessfulAfterIdentCanCorrect() = runTest {
        ...
        identificationScan.setProgress(false).assertIsDisplayed() // TODO the progress indicator should not be shown yet
