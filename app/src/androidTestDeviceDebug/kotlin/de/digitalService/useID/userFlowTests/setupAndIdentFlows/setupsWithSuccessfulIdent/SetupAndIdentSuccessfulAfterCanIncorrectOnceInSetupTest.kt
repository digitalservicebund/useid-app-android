...
import de.digitalService.useID.userFlowTests.utils.flowFragments.runSetupCanSuccessfulAfterCanWrongOnce
...
@HiltAndroidTest
class SetupAndIdentSuccessfulAfterCanIncorrectOnceInSetupTest {
    ...
    @Test
    fun testSetupAndIdentSuccessfulAfterCanIncorrectOnceInSetup() = runTest {
        ...
        runSetupCanSuccessfulAfterCanWrongOnce(
            testRule = composeTestRule,
            eidFlow = eidFlow,
            testScope = this
        )
