...
//@HiltAndroidTest
//class IdentCanSuccessfulOnThirdAttemptNavigationTest {
//
//    @get:Rule(order = 0)
...
//    @Test
//    fun testIdentCanSuccessfulOnThirdAttemptNavigation() = runTest {
...
//
//        identificationCanInput.assertIsDisplayed()
//        identificationCanInput.canEntryField.assertLength(can.length) // TODO: This should work, the input should be stored. Ticket: https://digitalservicebund.atlassian.net/browse/USEID-907
//        composeTestRule.pressReturn()
//        advanceUntilIdle()
//
//        identificationPersonalPin.setAttemptsLeft(1).assertIsDisplayed()
