...
@HiltAndroidTest
class SetupCanErrorAfterSomeTimeCardBlockedAfterTransportPinIncorrectTest {
    ...
    @Test
    fun testSetupCanErrorAfterSomeTimeCardBlockedAfterTransportPinIncorrect() = runTest {
