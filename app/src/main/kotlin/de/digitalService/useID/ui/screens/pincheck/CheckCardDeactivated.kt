...
import de.digitalService.useID.ui.screens.error.viewModel.CheckCardErrorViewModel
import de.digitalService.useID.ui.screens.error.viewModel.SetupCardErrorViewModel

@Destination
@Composable
fun CheckCardDeactivated(viewModel: CheckCardErrorViewModel = hiltViewModel()) {
    ScanErrorScreen(
        titleResId = R.string.scanError_cardDeactivated_title,
        bodyResId = R.string.scanError_cardDeactivated_body,
        buttonTitleResId = R.string.firstTimeUser_missingPINLetter_title,
